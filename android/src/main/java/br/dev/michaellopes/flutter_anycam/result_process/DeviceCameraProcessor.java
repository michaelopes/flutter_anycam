...
public class DeviceCameraProcessor extends BaseResultProcessor<ImageProxy> {

    @SuppressLint("RestrictedApi")
    public Map<String, Object> process(ImageProxy input, int width, int height, Integer customRotationDegrees) {
